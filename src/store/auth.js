...
export function mapApiParticipantToProfile(participant, publicId) {
  ...
  return {
    ...
    demoAccount: participant?.demo_account === true,
...
export async function registerWithApi(body) {
  const data = await apiRequest('/v1/auth/participant/register', {
    ...
    body: {
      ...
      participant_signature_agreed: body.participantSignatureAgreed,
      guardian_signature_agreed: body.guardianSignatureAgreed,
